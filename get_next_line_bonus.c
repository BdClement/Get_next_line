...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/13 12:32:47 by clbernar          #+#    #+#             */
/*   Updated: 2022/12/15 13:13:30 by clbernar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	clean_lst(t_list **lst)
{
	...
	i = 0;
	k = 0;
	rest_of_line = malloc(sizeof(t_list));
...
{
	char			*line;
	static t_list	*lst[1000];

	line = NULL;
	if (fd < 0 || fd > 1000 || BUFFER_SIZE <= 0)
		return (NULL);
	read_and_stock(fd, &lst[fd]);
	if (lst[fd] == NULL)
		return (NULL);
